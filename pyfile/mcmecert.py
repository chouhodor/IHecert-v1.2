...
root = tk.Tk()
root.title("MedicalCME Cert v1.2 - IKRAMHealth")
...
#########TITLE#############
label1 = tk.Label(text='MedicalCME Cert', bg='lightsteelblue',
                  fg='black', font=('helvetica', 40, 'bold'))
canvas1.create_window(250, 90, window=label1)

created_by = tk.Label(text='created by sufian safaai   version 1.1 - IKRAMHealth',
